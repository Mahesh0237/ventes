        ...
        <div style={{ background: "#ba176a1f" }}>
            <Container size={1400} py={60}>
                <Stack align='center'>
                    ...
                    <Text fw={700} style={{ fontSize: "28px" }}>MASTERING THE REAL ESTATE LANDSCAPE:
                        OUR EXPERTISE UNVEILED</Text>
                </Stack>
                <Grid py={30}>
                    ...
                    <Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
                        <Whatwedocard
                            heading="Interiors"
                            para="We provide comprehensive interior design and furnishing services to enhance the aesthetic appeal and functionality of residential, commercial."
                        />
                    </Grid.Col>
                    <Grid.Col span={{ base: 12, md: 6, lg: 6 }}>
                        <Whatwedocard

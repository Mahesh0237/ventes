...
import latestproject1 from '../../assets/latestproject3.jpg'
import latestproject2 from '../../assets/latestproject4.png'
...
function Projectwrapper() {
    return (
        <main className="listings-page margin-top-page mb-5">
            <Container size={1600} >
